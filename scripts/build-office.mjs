...
const CFG = {
  "Office of Readings": {
    ...
    hymn: HYMN.readings,
    psalms: [
      { label: "Invitatory · Psalm 95", ref: "Psalm 95", antiphon: "Come, let us worship the Lord, the great King above all gods.", book: "Psalm", ch: 95, a: 1, b: 200 },
      { label: "Psalm 1", ref: "Psalm 1", antiphon: "Blessed is the man whose delight is in the law of the Lord.", book: "Psalm", ch: 1, a: 1, b: 200 },
      { label: "Psalm 103", ref: "Psalm 103", antiphon: "Bless the Lord, O my soul, and forget not all his benefits.", book: "Psalm", ch: 103, a: 1, b: 200 },
    ],
  ...
  Lauds: {
    ...
    hymn: HYMN.lauds,
    psalms: [
      { label: "Psalm 63", ref: "Psalm 63", antiphon: "O God, my God, to thee do I watch at the break of day.", book: "Psalm", ch: 63, a: 2, b: 200 },
      { label: "Psalm 100", ref: "Psalm 100", antiphon: "Serve the Lord with gladness; come before him with joyful song.", book: "Psalm", ch: 100, a: 2, b: 200 },
      { label: "Psalm 148", ref: "Psalm 148", antiphon: "Praise the Lord from the heavens; praise him in the heights.", book: "Psalm", ch: 150, a: 1, b: 200 },
    ],
  ...
  Terce: {
    ...
    hymn: HYMN.terce,
    psalms: [
      { label: "Psalm 67", ref: "Psalm 67", antiphon: "May God have mercy on us, and bless us.", book: "Psalm", ch: 67, a: 2, b: 200 },
      { label: "Psalm 8", ref: "Psalm 8", antiphon: "O Lord, our Lord, how admirable is thy name in all the earth!", book: "Psalm", ch: 8, a: 2, b: 200 },
      { label: "Psalm 19", ref: "Psalm 19", antiphon: "The heavens declare the glory of God.", book: "Psalm", ch: 19, a: 2, b: 200 },
    ],
  ...
  Sext: {
    ...
    hymn: HYMN.sext,
    psalms: [
      { label: "Psalm 121", ref: "Psalm 121", antiphon: "My help is from the Lord, who made heaven and earth.", book: "Psalm", ch: 122, a: 1, b: 200 },
      { label: "Psalm 122", ref: "Psalm 122", antiphon: "I rejoiced when they said to me: Let us go to the house of the Lord.", book: "Psalm", ch: 123, a: 1, b: 200 },
      { label: "Psalm 84", ref: "Psalm 84", antiphon: "How lovely is thy dwelling place, O Lord of hosts!", book: "Psalm", ch: 84, a: 2, b: 200 },
    ],
  ...
  None: {
    ...
    hymn: HYMN.none,
    psalms: [
      { label: "Psalm 125", ref: "Psalm 125", antiphon: "They that trust in the Lord shall be as Mount Sion, which cannot be moved.", book: "Psalm", ch: 126, a: 1, b: 200 },
      { label: "Psalm 130", ref: "Psalm 130 · De Profundis", antiphon: "Out of the depths I have cried to thee, O Lord.", book: "Psalm", ch: 131, a: 1, b: 200 },
      { label: "Psalm 16", ref: "Psalm 16", antiphon: "Preserve me, O God, for in thee have I taken refuge.", book: "Psalm", ch: 16, a: 1, b: 200 },
    ],
  ...
  Vespers: {
    ...
    hymn: HYMN.vespers,
    psalms: [
      { label: "Psalm 113", ref: "Psalm 113", antiphon: "Praise the Lord, ye servants of the Lord; blessed be the name of the Lord.", book: "Psalm", ch: 113, a: 1, b: 200 },
      { label: "Psalm 23", ref: "Psalm 23", antiphon: "The Lord is my shepherd; there is nothing I shall want.", book: "Psalm", ch: 23, a: 1, b: 200 },
      { label: "Psalm 117", ref: "Psalm 117", antiphon: "O praise the Lord, all ye nations; for his mercy is confirmed upon us.", book: "Psalm", ch: 117, a: 1, b: 200 },
    ],
  ...
  Compline: {
    ...
    hymn: HYMN.compline,
    psalms: [
      { label: "Psalm 4", ref: "Psalm 4", antiphon: "Have mercy on me, O Lord, and hear my prayer.", book: "Psalm", ch: 4, a: 2, b: 200 },
      { label: "Psalm 91", ref: "Psalm 91", antiphon: "He that dwelleth in the aid of the Most High shall abide under the protection of the God of heaven.", book: "Psalm", ch: 91, a: 1, b: 200 },
      { label: "Psalm 133", ref: "Psalm 133", antiphon: "Behold how good and pleasant it is for brethren to dwell together in unity.", book: "Psalm", ch: 134, a: 1, b: 200 },
    ],
